...
package com.liferay.fragment.web.internal.portlet.action.test;
...
public class AddFragmentEntryMVCActionCommandTest {
	...
	public void testAddFragmentEntryLink() throws Exception {
		...
		MockActionResponse mockActionResponse =
			new MockLiferayPortletResponse();

		_portlet.processAction(mockActionRequest, mockActionResponse);

		HttpServletResponse mockHttpServletResponse =
			((MockLiferayPortletResponse)mockActionResponse).
	...
	private MockActionRequest _getMockActionRequest() throws PortalException {
		...
		FragmentCollection fragmentCollection =
			FragmentCollectionLocalServiceUtil.addFragmentCollection(
				user.getUserId(), _group.getGroupId(), "Fragment Collection",
		...
		mockActionRequest.addParameter("name", "Test Fragment");
	...
	private static class MockLiferayPortletResponse
		extends MockActionResponse implements LiferayPortletResponse {
