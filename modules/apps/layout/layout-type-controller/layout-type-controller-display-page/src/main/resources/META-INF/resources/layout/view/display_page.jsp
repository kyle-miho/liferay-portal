								...
								%>
									...
									<div class="col <%= Validator.isNotNull(size) ? "col-" + size : StringPool.BLANK %>">
										...
										%>
											...
											<%= FragmentEntryRenderUtil.renderFragmentEntryLink(fragmentEntryLink, FragmentEntryLinkConstants.ASSET_DISPLAY_PAGE, displayPageLayoutTypeControllerDisplayContext.getInfoDisplayFieldsValues(), locale, segmentsExperienceIds, request, response) %>
